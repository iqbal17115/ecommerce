                        ...
                        <div class="tab-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 mt-md-3">
                                                     <select name="brand_available" id="brand_available" onchange="brandAvailableCheck(this)" class="form-select" required>
                                                        <option value="">Select Option</option>
                                                        <option @if($productInfo && $productInfo->brand_available==1) selected @endif value="1">Yes</option>
                                                        <option @if($productInfo && $productInfo->brand_available==0) selected @endif value="0">No</option>
                                                    </select>
                                                 </div>
                                                <!-- End -->
                            ...
                            <div class="tab-pane add_vital_info" id="addVitalInfo" role="tabpanel">
                                <form method="post" id="add_vital_info">
                                    @csrf
                                    <div class="row">
                                        <input type="hidden" name="vital_info_id" id="vital_info_id" @if($productInfo)
                                            value="{{$productInfo->id}}" @else value="-1" @endif />
                                        <!-- Start -->
                                        <div class="col-md-10">
                                            <!-- Start Content -->
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 mt-md-3">
                                                    <select name="product_feature_id" id="product_feature_id"
                                                        ...
                                                        <option @if($productInfo && $productInfo->
                                                            product_feature_id==$product_feature->id) selected @endif
                                                ...
                                                <div class="col-md-8 mt-md-3">
                                                    ...
                                                    value="{{$productInfo->outer_material}}" @endif class="form-control"
                                                ...
                                                <div class="col-md-8 mt-md-3">
                                                    <select class="form-select" name="condition_id" id="condition_id"
                                                        ...
                                                        <option value="{{ $condition->id }}" @if($productInfo &&
                                                            $productInfo->ProductDetail &&
                                                            $productInfo->ProductDetail->condition_id==$condition->id)
                                                            selected @endif>{{ $condition->title }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-8 mt-md-3">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" name="booking_date" id="booking_date"
                                                            @if($productInfo) value="{{$productInfo->booking_date}}"
