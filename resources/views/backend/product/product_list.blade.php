...
@section('content')
                        ...
                        <tbody>
                            ...
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td style="word-wrap: break-word; white-space: pre-line;">{{ $product->seller_sku }}
                                    </td>
                                    <td>
                                        <a class="badge badge-secondary product_stock_qty_{{ $product->id }}"
                                            data-product_id="{{ $product->id }}" data-stock_qty="{{ $product->stock_qty }}"
                                            data-toggle="modal" data-target="#productStockQtyModal"
                                            id="product_stock_qty">{{ $product->stock_qty }}</a>
                                    </td>
    ...
    <div id="productStockQtyModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myCountryLabel"
        aria-hidden="true">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title mt-0" id="myCountryLabel">Product qty</h5>
