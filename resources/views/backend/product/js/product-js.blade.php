    ...
    function variationManage(variation_type, val) {
        ...
        if (variation_type == 1) {
            ...
            if (len == 0) {
                ...
                variation_content += '<div style="width: 150px;"><select name="input_bottom_size_map[]" class="select-form bottom_size_map"></select></div>';
                variation_content += '<div class="div_color" style="display: none;width: 150px;"><select name="input_color_map[]" class="select-form color_map"></select></div>';
            ...
            if (len == 0) {
                ...
                variation_content += '<div class="div_size" style="display: none; width: 150px;"><select name="input_bottom_size_map[]" class="select-form bottom_size_map"></select></div>';
                variation_content += '<div style="width: 150px;"><select name="input_color_map[]" class="select-form color_map"></select></div>';
                variation_content += '<div style="width: 150px;"><input name="input_description[]" class="input-form" /></div>';
                variation_content += '<div style="width: 150px;"><input name="input_seller_sku[]" class="input-form" /></div>';
                variation_content += '<div style="width: 150px;"><input name="input_product_code[]" class="input-form" /></div>';
                variation_content += '<div style="width: 150px;"><select name="input_type" class="select-form "><option value="">Select Option</option><option value="GTIN">GTIN</option><option value="EAN">EAN</option><option value="GCID">GCID</option><option value="UPC">UPC</option><option value="ASIN">ASIN</option><option value="ISBN">ISBN</option></select></div>';
