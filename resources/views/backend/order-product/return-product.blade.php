            ...
            <div class="card shadow">
                <div class="card-body">
                    <h5 class="card-title mb-4">
                        <div class="row">
                            <div class="col-md-9 text-success">Return Product</div>
                            <div class="col-md-3">
                                <div class="row">
                    ...
                    <form action="{{ route('order_quantity_changes') }}" id="canceOrderlReason">
                        @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <input type="text" value="{{ $orderDetail->quantity }}"
                                                name="product_order_qty_{{ $orderDetail->Product->id }}"
                                                id="product_order_qty_{{ $orderDetail->Product->id }}"
                                                class="form-control form-control-sm" readonly />
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text"
                                                name="product_order_cancel_qty_{{ $orderDetail->Product->id }}"
                                                id="product_order_cancel_qty_{{ $orderDetail->Product->id }}"
                                                class="form-control form-control-sm" readonly />
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text"
                                                name="product_order_remaining_qty_{{ $orderDetail->Product->id }}"
                                                id="product_order_remaining_qty_{{ $orderDetail->Product->id }}"
                                                class="form-control form-control-sm" readonly />
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            <select name="product_return_reason_{{ $orderDetail->Product->id }}"
                                                id="product_return_reason_{{ $orderDetail->Product->id }}"
