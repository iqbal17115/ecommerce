                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="name" id="name"
                                                            @if ($company_info) value="{{ $company_info->name }}" @endif
                                                    ...
                                                    <div class="col-md-4 mt-md-3">
                                                        ...
                                                        @if ($company_info && $company_info->logo)
                                                            <img src="{{ asset('storage/' . $company_info->footer_logo) }}"
                                                                class="rounded float-md-right"
                                                                style="width: 55px; height: 30px;" alt="" />
                                                        @endif
                                                    </div>
                                                    <div class="col-md-8 mt-md-3">
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="footer_ads" id="footer_ads"
                                                            @if ($company_info) value="{{ $company_info->footer_ads }}" @endif
                                                            class="form-control" placeholder="Footer Ads">
                                                    </div>
                                                    <!-- End -->
                                                    <div class="col-md-4 mt-md-3">
                                                        <label class="col-form-label float-md-right"
                                                    ...
                                                    <div class="col-md-6 mt-md-3">
                                                        <input type="text" name="phone" id="phone"
                                                            @if ($company_info) value="{{ $company_info->phone }}" @endif
                                                            class="form-control" placeholder="Phone">
                                                    </div>
                                                    <!-- End -->
                                                    <div class="col-md-2 mt-md-3">
                                                        <div class="form-check form-switch">
                                                            <input @if ($company_info && $company_info->is_phone_active) checked @endif
                                                    ...
                                                    <div class="col-md-6 mt-md-3">
                                                        <input type="text" name="mobile" id="mobile"
                                                            @if ($company_info) value="{{ $company_info->mobile }}" @endif
                                                            class="form-control" placeholder="Mobile">
                                                    </div>
                                                    <!-- End -->
                                                    <div class="col-md-2 mt-md-3">
                                                        <div class="form-check form-switch">
                                                            <input @if ($company_info && $company_info->is_mobile_active) checked @endif
                                                                class="form-check-input" type="checkbox"
                                                                name="is_mobile_active" id="is_mobile_active">
                                                    ...
                                                    <div class="col-md-6 mt-md-3">
                                                        <input type="email" name="email" id="email"
                                                            @if ($company_info) value="{{ $company_info->email }}" @endif
                                                    ...
                                                    <div class="col-md-2 mt-md-3">
                                                        <div class="form-check form-switch">
                                                            <input @if ($company_info && $company_info->is_email_active) checked @endif
                                                                class="form-check-input" type="checkbox"
                                                                name="is_email_active" id="is_email_active">
                                                    ...
                                                    <div class="col-md-6 mt-md-3">
                                                        <input type="text" name="hotline" id="hotline"
                                                            @if ($company_info) value="{{ $company_info->hotline }}" @endif
                                                    ...
                                                    <div class="col-md-2 mt-md-3">
                                                        <div class="form-check form-switch">
                                                            <input @if ($company_info && $company_info->is_hotline_active) checked @endif
                                                                class="form-check-input" type="checkbox"
                                                                name="is_hotline_active" id="is_hotline_active">
                                                            <label class="form-check-label"
                                                                for="is_hotline_active">Hotline
                                                                Active</label>
                                                        </div>
                                                    </div>
                                                    <!-- End -->
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="address" id="address"
                                                            @if ($company_info) value="{{ $company_info->address }}" @endif
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="google_map_location"
                                                            @if ($company_info) value="{{ $company_info->google_map_location }}" @endif
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="web" id="web"
                                                            @if ($company_info) value="{{ $company_info->web }}" @endif
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="video_link"
                                                            @if ($company_info) value="{{ $company_info->video_link }}" @endif
                                                            id="video_link" class="form-control"
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="video_title"
                                                            @if ($company_info) value="{{ $company_info->video_title }}" @endif
                                                            id="video_title" class="form-control"
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="facebook_link"
                                                            @if ($company_info) value="{{ $company_info->facebook_link }}" @endif
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="youtube_link"
                                                            @if ($company_info) value="{{ $company_info->youtube_link }}" @endif
                                                            id="youtube_link" class="form-control"
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="twitter_link"
                                                            @if ($company_info) value="{{ $company_info->twitter_link }}" @endif
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="instagram_link"
                                                            @if ($company_info) value="{{ $company_info->instagram_link }}" @endif
                                                            id="instagram_link" class="form-control"
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <input type="text" name="linkedin_link"
                                                            @if ($company_info) value="{{ $company_info->linkedin_link }}" @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <textarea class="form-control" name="about_us" id="about_us" placeholder="About Us">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <textarea class="form-control" name="terms_condition" id="terms_condition" placeholder="Terms & Condition">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <textarea class="form-control" name="privacy_policy" id="privacy_policy" placeholder="Privacy Policy">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <textarea class="form-control" name="return_policy" id="return_policy" placeholder="Return Policy">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 mt-md-3">
                                                        <textarea class="form-control" name="shipping_and_delivery" id="shipping_and_delivery"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 mt-md-3">
                                                        <div class="form-check form-switch">
                                                            <input @if ($company_info && $company_info->is_footer_block1_active) checked @endif
                                                                class="form-check-input" type="checkbox"
                                                    ...
                                                    <div class="col-md-12 mt-md-3">
                                                        <div class="form-check form-switch">
                                                            <input @if ($company_info && $company_info->is_footer_block2_active) checked @endif
                                                                class="form-check-input" type="checkbox"
                                                    ...
                                                    <div class="col-md-12 mt-md-3">
                                                        <div class="form-check form-switch">
                                                            <input @if ($company_info && $company_info->is_footer_block3_active) checked @endif
                                                                class="form-check-input" type="checkbox"
