...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-12 shipping_charge_content">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-info text-light btn-sm update_form" data-toggle="modal" data-target="#blockModal" data-id="{{$shipping_charge->id}}" data-type="{{$shipping_charge->type}}" data-inside_amount="{{$shipping_charge->inside_amount}}" data-outside_amount="{{$shipping_charge->outside_amount}}" data-is_active="{{$shipping_charge->is_active}}">
                                    <i class="mdi mdi-pencil font-size-16"></i>
                                </button>
                                <button type="button" class="btn btn-danger text-light btn-sm delete_shipping_charge" data-id="{{$shipping_charge->id}}">
