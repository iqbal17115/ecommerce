            ...
            <div class="bg-gray pb-5">
                ...
                'autoplayTimeout':5000
                        ...
                        <div class="home-slide home-slide1 banner">
                            <img class="slide-bg" src="{{ asset('aladdinne/assets/images/demoes/demo36/slider/slide-1.jpg') }}" alt="slider image">
                            <div class="container d-flex align-items-sm-center justify-content-sm-between justify-content-center flex-column flex-sm-row">
                                ...
                                <div class="banner-content content-right appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="1000">
                                    ...
                                    <a href="demo36-shop.html" class="btn btn-dark btn-lg">Shop Now</a>
                                </div>
                                <!-- End .banner-layer -->
                            </div>
                        </div>
                        ...
                        <div class="home-slide home-slide2 banner banner-md-vw">
                            <img class="slide-bg" src="{{ asset('aladdinne/assets/images/demoes/demo36/slider/slide-2.jpg') }}" alt="slider image">
                        ...
                        <div class="categories-slider owl-carousel owl-theme show-nav-hover nav-outer" data-owl-options="{
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="demo36-shop.html">
                                    <figure>
                                        <img src="{{ asset('aladdinne/assets/images/demoes/demo36/products/categories/category-1.jpg') }}" alt="category" width="280" height="240" />
                                    </figure>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="demo36-shop.html">
                                    <figure>
                                        <img src="{{ asset('aladdinne/assets/images/demoes/demo36/products/categories/category-2.jpg') }}" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Furniture</h3>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="demo36-shop.html">
                                    <figure>
                                        <img src="{{ asset('aladdinne/assets/images/demoes/demo36/products/categories/category-3.jpg') }}" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Sports</h3>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="demo36-shop.html">
                                    <figure>
                                        <img src="{{ asset('aladdinne/assets/images/demoes/demo36/products/categories/category-4.jpg') }}" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Toys</h3>
                                        <span><mark class="count">2</mark> products</span>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="demo36-shop.html">
                                    <figure>
                                        <img src="{{ asset('aladdinne/assets/images/demoes/demo36/products/categories/category-5.jpg') }}" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Cameras</h3>
                                        <span><mark class="count">1</mark> products</span>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="demo36-shop.html">
                                    <figure>
                                        <img src="{{ asset('aladdinne/assets/images/demoes/demo36/products/categories/category-6.jpg') }}" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Gaming</h3>
                                        <span><mark class="count">1</mark> products</span>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="demo36-shop.html">
                                    <figure>
                                        <img src="{{ asset('aladdinne/assets/images/demoes/demo36/products/categories/category-7.jpg') }}" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Headphones</h3>
                                        <span><mark class="count">1</mark> products</span>
                            ...
                            <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                                <a href="demo36-shop.html">
                                    <figure>
                                        <img src="{{ asset('aladdinne/assets/images/demoes/demo36/products/categories/category-8.jpg') }}" alt="category" width="220" height="220" />
                                    </figure>
                                    <div class="category-content">
                                        <h3>Smartphones</h3>
                                        <span><mark class="count">1</mark> products</span>
