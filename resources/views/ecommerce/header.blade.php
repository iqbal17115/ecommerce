                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="demo36-product.html" class="product-image">
                                                    <img src="{{ asset('aladdinne/assets/images/demoes/demo36/products/product-1.jpg') }}" alt="product" width="80" height="80">
                                                </a>
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="demo36-product.html" class="product-image">
                                                    <img src="{{ asset('aladdinne/assets/images/demoes/demo36/products/product-2.jpg') }}" alt="product" width="80" height="80">
                                                </a>
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="demo36-product.html" class="product-image">
                                                    <img src="{{ asset('aladdinne/assets/images/demoes/demo36/products/product-3.jpg') }}" alt="product" width="80" height="80">
                                                </a>
                                                <a href="#" class="btn-remove" title="Remove Product"><span>×</span></a>
                                            </figure>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 p-0">
                                            <div class="menu-banner">
                                                <figure>
                                                    <img src="{{ asset('aladdinne/assets/images/menu-banner.jpg') }}" width="192" height="313" alt="Menu banner">
                                                </figure>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 p-0">
                                            <div class="menu-banner menu-banner-2">
                                                <figure>
                                                    <img src="{{ asset('aladdinne/assets/images/menu-banner-1.jpg') }}" alt="Menu banner" class="product-promo">
                                                </figure>
                                                <i>OFF</i>
                                                <div class="banner-content">
                                                    <h4>
