            ...
            function loadUserOrder(user_id) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        orderHtml += '<h5 class="card-title">Order ID# ' + order.code + '</h5>';
                        orderHtml += '<p class="card-text">Ordered On </p>';
                        orderHtml += '</div>';
                        orderHtml += '<div class="col-md-4 d-flex justify-content-center align-items-center">';
                        orderHtml += '<div>';
                        orderHtml += '<h5 class="card-title">Estimated Delivery</h5>';
                        orderHtml += '<p class="card-text">By </p>';
                        orderHtml += '</div>';
                        orderHtml += '</div>';
                        orderHtml += '<div class="col-md-2 d-flex justify-content-center align-items-center">';
                        orderHtml += '<div>';
                        orderHtml += '<h5 class="card-title">Order Total</h5>';
                        orderHtml += '<p class="card-text">Taka ' + order.payable_amount + '</p>';
                        orderHtml += '</div>';
                        orderHtml += '</div>';
                        orderHtml += '<div class="col-md-2 justify-content-center align-items-center">';
                        orderHtml += '<button class="btn btn-sm btn-primary mb-2">Track Package</button><br>';
                        ...
                        $.each(order.order_detail, function(index, orderDetail) {
                            ...
                            if (orderDetail.product != null) {
                                orderDetailHtml += '<img src="' + orderDetail.product.name + '" style="width:70px; height:70px;" class="img-responsive">';
                            }
                            orderDetailHtml += '</div>';
                            orderDetailHtml += '<div class="col-md-5">';
                            if (orderDetail.product != null) {
                                orderDetailHtml += '<h6 class="mb-3">' + orderDetail.product.name + '</h6>';
                            }
                            orderDetailHtml += '</div>';
                            orderDetailHtml += '<div class="col-md-2">';
                            orderDetailHtml += '<h6 class="mb-3 badge badge-danger p-2 rounded">' + order.status + '</h6>';
                            orderDetailHtml += '</div>';
                            orderDetailHtml += '<div class="col-md-2">Standard Delivery</div>';
                            orderDetailHtml += '<div class="col-md-2">';
                            // No buttons here
                            orderDetailHtml += '</div>';
