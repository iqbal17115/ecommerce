                    ...
                    <div class="module-inner">
                        ...
                        <div class="content-panel">
                            <div class="tab-content">
                                ...
                                @include('ecommerce.my-account.partials.reward_and_gift_card')
                                @include('ecommerce.my-account.partials.reward_points')
                                @include('ecommerce.my-account.partials.gift_cards')
                ...
                <div class="order-summary mt-4 p-3 border rounded bg-white">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tr class="border-top">
                            ...
                            <td class="text-end"><h5 class="fw-bold text-success">${formatPrice(Number(order.total_amount) - Number(order.discount) + Number(order.shipping_charge))}</h5></td>
                        </tr>
                    </table>
                </div>
            </div>
