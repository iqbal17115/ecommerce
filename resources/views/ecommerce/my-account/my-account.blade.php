                    ...
                    $.each(orders, function(index, order) {
                        ...
                        $.each(order.order_detail, function(index, orderDetail) {
                            ...
                            if (orderDetail.product != null) {
                                orderDetailHtml += '<img src="' + orderDetail.product.name +
                                    '" style="width:70px; height:70px;" class="img-responsive">';
                            }
                            orderDetailHtml += '</div>';
                            orderDetailHtml += '<div class="col-md-5">';
                            if (orderDetail.product != null) {
                                orderDetailHtml += '<h6 class="mb-3">' + orderDetail.product
                                    .name + '</h6>';
                            }
                            orderDetailHtml += '</div>';
                            orderDetailHtml += '<div class="col-md-2">';
                            orderDetailHtml +=
                                '<h6 class="mb-3 badge badge-danger p-2 rounded">' + order
                                .status + '</h6>';
                            orderDetailHtml += '</div>';
                            orderDetailHtml += '<div class="col-md-2">Standard Delivery</div>';
                            orderDetailHtml += '<div class="col-md-2"></div>';
                            orderDetailHtml += '</div>';
