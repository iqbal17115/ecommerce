                            ...
                            <div class="card shadow-sm mb-3">
                                ...
                                <div class="card-body pt-0 mt-0">
                                    <h5 class="card-title text-center">
                                        @if (Auth::user() && Auth::user()->Contact)
                                            {{ Auth::user()->Contact->first_name }}@endif
                                    </h5>
                        ...
                        <div class="col-md-8">
                            ...
                            <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-grp">
                                                    <label for="fName" style="color: black;">দোকানের
                                                        নাম<span>*</span></label>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-grp">
                                                    <label for="fName" style="color: black;">আপনার নাম<span>*</span></label>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-grp">
                                                    <label for="mobile" style="color: black;">মোবাইল
                                                        নাম্বার<span>*</span></label>
                                ...
                                <div class="form-grp">
                                    ...
                                    <select class="custom-select form-control" id="district" name="district" required>
                                        ...
                                        <option value="California">Barisal</option>
                                            ...
                                            <div class="col-12 mt-1">
                                                <div class="form-grp">
                                                    <label for="shipping_address" style="color: black;">পূর্ণ
                                                        ঠিকানা*</label>
                                    ...
                                    placeholder="আপনার পূর্ণ ঠিকানা লিখুন" style="height: 50px;"> --}}
                                                    <textarea id="shipping_address" class="form-control"
                                                        name="shipping_address" placeholder="আপনার পূর্ণ ঠিকানা লিখুন"
                                                        style="height: 100px;" required
                                                        placeholder="আপনার পূর্ণ ঠিকানা লিখুন">
    @if (Auth::user() && Auth::user()->Contact){{ Auth::user()->Contact->shipping_address }}@endif
    </textarea>
                                                </div>
                                            </div>
                                            <div class="col-12">
                    ...
                    <hr>
                                        ...
                                        <button type="submit"
                                            class="float-right border p-1 rounded text-info text-light px-3"
                                                ...
                                                @if (isset($contact->Order))
                                                    @foreach ($contact->Order as $order)
                                                        <tr>
                                                            ...
                                                            <td data-label="তারিখ">
                                                                {{ date('d F Y', strtotime($order->order_date)) }}</td>
                                ...
                                <div class="card-body basic tab-pane" id="change-password">
                                    ...
                                    <hr class="mt-2">
                                    <form id="change-password-customer" action="{{ route('change-password-customer') }}"
                                        method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input name="oldpassword" id="oldpassword" type="password"
                                                    class="form-control" placeholder="পূর্বের পাসওয়ার্ড" required />
                                            </div>
                                            <div class="col-md-6 mt-2">
                                                <input name="newpassword" id="newpassword" type="password"
                                                    class="form-control" placeholder="নতুন পাসওয়ার্ড (সর্বনিম্ন ৪ সংখ্যা)"
                                                    required />
                                            </div>
                                            <div class="col-md-6 mt-2">
                                                <input name="password_confirmation" id="password_confirmation"
                                                    type="password" class="form-control" placeholder="কনফার্ম পাসওয়ার্ড"
                                                    required />
                                            </div>
                                            <div class="col-md-12">
                                                <center>
