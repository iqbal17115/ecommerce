...
@section('content')
    ...
    <div id="countryModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myCountryLabel" aria-hidden="true">
...
@endsection
@push('scripts')
<script src="{{asset('js/admin_panel/shop_setting/country.js')}}"></script>
<script>
    loadDataTable();
</script>
@endpush
