...
@section('content')
    ...
    <div id="countryModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myDivisionLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <x-custom-input-label for="country_id" label="Country" :required="true" />
                                @include("components.select-option", ["dataTable" => "countries", "name" => "country_id", "id" =>'country_id'])
                            </div>
                            <div class="col-md-12">
...
@endsection
@push('scripts')
<script src="{{asset('js/admin_panel/shop_setting/division.js')}}"></script>
<script>
    loadDataTable();
</script>
@endpush
